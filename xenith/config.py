...
def _parser():
    ...
    mod_help = ("What model should be used? The easiest option is to"
                "select one of the xenith pretrained models designed for "
                "output from Kojak. These are:\n "
                "(1) 'kojak_mlp' - A multilayer perceptron model for output"
                " from Kojak 2.0.0.\n "
                ...
                "Alternatively, a custom xenith model file or the weights "
                "output from Percolator can be used.")
    ...
    predict.add_argument("-r", "--fileroot",
                         ...
                         help=("The fileroot string will be added as a"
                               " prefix to all output file names."))
    ...
    kojak.add_argument("-c", "--max_charge",
                       ...
                       help=("Integer indicating the maximum charge state "
                             "to consider. This must be 8 to use the included "
                             "pretrained models."))
